...
export class MailButton extends LitElement {
  ...
  render() {
    const classList = classNames(
      'flex px-3 tracking-wider gap-2 text-zinc-50 text-[.75rem] uppercase items-center py-2.5 leading-none rounded-full whitespace-nowrap font-medium active:scale-95'
    )
