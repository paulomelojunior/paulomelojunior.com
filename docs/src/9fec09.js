 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var nc,zi,Bn,ol,on,rc,al,Up=function(){return typeof window<"u"},Ci={},tn=180/Math.PI,qn=Math.PI/180,zn=Math.atan2,sc=1e8,ll=/([A-Z])/g,Hp=/(left|right|width|margin|padding|x)/i,Vp=/[\s,\(]\S/,ri={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},ca=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},Bp=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},qp=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},Wp=function(e,t){return t.set(t.t,t.p,e===1?t.e:e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},Yp=function(e,t){var i=t.s+t.c*e;t.set(t.t,t.p,~~(i+(i<0?-.5:.5))+t.u,t)},Qu=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},ed=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},Xp=function(e,t,i){return e.style[t]=i},Gp=function(e,t,i){return e.style.setProperty(t,i)},Kp=function(e,t,i){return e._gsap[t]=i},Jp=function(e,t,i){return e._gsap.scaleX=e._gsap.scaleY=i},Zp=function(e,t,i,n,r){var o=e._gsap;o.scaleX=o.scaleY=i,o.renderTransform(r,o)},Qp=function(e,t,i,n,r){var o=e._gsap;o[t]=i,o.renderTransform(r,o)},xe="transform",wt=xe+"Origin",eg=function s(e,t){var i=this,n=this.target,r=n.style,o=n._gsap;if(e in Ci&&r){if(this.tfm=this.tfm||{},e!=="transform")e=ri[e]||e,~e.indexOf(",")?e.split(",").forEach(function(a){return i.tfm[a]=_i(n,a)}):this.tfm[e]=o.x?o[e]:_i(n,e),e===wt&&(this.tfm.zOrigin=o.zOrigin);else return ri.transform.split(",").forEach(function(a){return s.call(i,a,t)});if(this.props.indexOf(xe)>=0)return;o.svg&&(this.svgo=n.getAttribute("data-svg-origin"),this.props.push(wt,t,"")),e=xe}(r||t)&&this.props.push(e,t,r[e])},td=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},tg=function(){var e=this.props,t=this.target,i=t.style,n=t._gsap,r,o;for(r=0;r<e.length;r+=3)e[r+1]?e[r+1]===2?t[e[r]](e[r+2]):t[e[r]]=e[r+2]:e[r+2]?i[e[r]]=e[r+2]:i.removeProperty(e[r].substr(0,2)==="--"?e[r]:e[r].replace(ll,"-$1").toLowerCase());if(this.tfm){for(o in this.tfm)n[o]=this.tfm[o];n.svg&&(n.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),r=al(),(!r||!r.isStart)&&!i[xe]&&(td(i),n.zOrigin&&i[wt]&&(i[wt]+=" "+n.zOrigin+"px",n.zOrigin=0,n.renderTransform()),n.uncache=1)}},id=function(e,t){var i={target:e,props:[],revert:tg,save:eg};return e._gsap||Ct.core.getCache(e),t&&e.style&&e.nodeType&&t.split(",").forEach(function(n){return i.save(n)}),i},nd,ua=function(e,t){var i=zi.createElementNS?zi.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):zi.createElement(e);return i&&i.style?i:zi.createElement(e)},zt=function s(e,t,i){var n=getComputedStyle(e);return n[t]||n.getPropertyValue(t.replace(ll,"-$1").toLowerCase())||n.getPropertyValue(t)||!i&&s(e,er(t)||t,1)||""},oc="O,Moz,ms,Ms,Webkit".split(","),er=function(e,t,i){var n=t||on,r=n.style,o=5;if(e in r&&!i)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);o--&&!(oc[o]+e in r););return o<0?null:(o===3?"ms":o>=0?oc[o]:"")+e},da=function(){Up()&&window.document&&(nc=window,zi=nc.document,Bn=zi.documentElement,on=ua("div")||{style:{}},ua("div"),xe=er(xe),wt=xe+"Origin",on.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",nd=!!er("perspective"),al=Ct.core.reverting,ol=1)},ac=function(e){var t=e.ownerSVGElement,i=ua("svg",t&&t.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=e.cloneNode(!0),r;n.style.display="block",i.appendChild(n),Bn.appendChild(i);try{r=n.getBBox()}catch{}return i.removeChild(n),Bn.removeChild(i),r},lc=function(e,t){for(var i=t.length;i--;)if(e.hasAttribute(t[i]))return e.getAttribute(t[i])},rd=function(e){var t,i;try{t=e.getBBox()}catch{t=ac(e),i=1}return t&&(t.width||t.height)||i||(t=ac(e)),t&&!t.width&&!t.x&&!t.y?{x:+lc(e,["x","cx","x1"])||0,y:+lc(e,["y","cy","y1"])||0,width:0,height:0}:t},sd=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&rd(e))},Vi=function(e,t){if(t){var i=e.style,n;t in Ci&&t!==wt&&(t=xe),i.removeProperty?(n=t.substr(0,2),(n==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),i.removeProperty(n==="--"?t:t.replace(ll,"-$1").toLowerCase())):i.removeAttribute(t)}},Di=function(e,t,i,n,r,o){var a=new xt(e._pt,t,i,0,1,o?ed:Qu);return e._pt=a,a.b=n,a.e=r,e._props.push(i),a},cc={deg:1,rad:1,turn:1},ig={grid:1,flex:1},Bi=function s(e,t,i,n){var r=parseFloat(i)||0,o=(i+"").trim().substr((r+"").length)||"px",a=on.style,l=Hp.test(t),c=e.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),d=100,h=n==="px",f=n==="%",g,p,_,b;if(n===o||!r||cc[n]||cc[o])return r;if(o!=="px"&&!h&&(r=s(e,t,i,"px")),b=e.getCTM&&sd(e),(f||o==="%")&&(Ci[t]||~t.indexOf("adius")))return g=b?e.getBBox()[l?"width":"height"]:e[u],Le(f?r/g*d:r/100*g);if(a[l?"width":"height"]=d+(h?o:n),p=n!=="rem"&&~t.indexOf("adius")||n==="em"&&e.appendChild&&!c?e:e.parentNode,b&&(p=(e.ownerSVGElement||{}).parentNode),(!p||p===zi||!p.appendChild)&&(p=zi.body),_=p._gsap,_&&f&&_.width&&l&&_.time===At.time&&!_.uncache)return Le(r/_.width*d);if(f&&(t==="height"||t==="width")){var v=e.style[t];e.style[t]=d+n,g=e[u],v?e.style[t]=v:Vi(e,t)}else(f||o==="%")&&!ig[zt(p,"display")]&&(a.position=zt(e,"position")),p===e&&(a.position="static"),p.appendChild(on),g=on[u],p.removeChild(on),a.position="absolute";return l&&f&&(_=cn(p),_.time=At.time,_.width=p[u]),Le(h?g*r/d:g&&r?d/g*r:0)},_i=function(e,t,i,n){var r;return ol||da(),t in ri&&t!=="transform"&&(t=ri[t],~t.indexOf(",")&&(t=t.split(",")[0])),Ci[t]&&t!=="transform"?(r=Zr(e,n),r=t!=="transformOrigin"?r[t]:r.svg?r.origin:io(zt(e,wt))+" "+r.zOrigin+"px"):(r=e.style[t],(!r||r==="auto"||n||~(r+"").indexOf("calc("))&&(r=to[t]&&to[t](e,t,i)||zt(e,t)||xu(e,t)||(t==="opacity"?1:0))),i&&!~(r+"").trim().indexOf(" ")?Bi(e,t,r,i)+i:r},ng=function(e,t,i,n){if(!i||i==="none"){var r=er(t,e,1),o=r&&zt(e,r,1);o&&o!==i?(t=r,i=o):t==="borderColor"&&(i=zt(e,"borderTopColor"))}var a=new xt(this._pt,e.style,t,0,1,Ku),l=0,c=0,u,d,h,f,g,p,_,b,v,x,w,S;if(a.b=i,a.e=n,i+="",n+="",n.substring(0,6)==="var(--"&&(n=zt(e,n.substring(4,n.indexOf(")")))),n==="auto"&&(p=e.style[t],e.style[t]=n,n=zt(e,t)||n,p?e.style[t]=p:Vi(e,t)),u=[i,n],Fu(u),i=u[0],n=u[1],h=i.match(Fn)||[],S=n.match(Fn)||[],S.length){for(;d=Fn.exec(n);)_=d[0],v=n.substring(l,d.index),g?g=(g+1)%5:(v.substr(-5)==="rgba("||v.substr(-5)==="hsla(")&&(g=1),_!==(p=h[c++]||"")&&(f=parseFloat(p)||0,w=p.substr((f+"").length),_.charAt(1)==="="&&(_=Vn(f,_)+w),b=parseFloat(_),x=_.substr((b+"").length),l=Fn.lastIndex-x.length,x||(x=x||Dt.units[t]||w,l===n.length&&(n+=x,a.e+=x)),w!==x&&(f=Bi(e,t,p,x)||0),a._pt={_next:a._pt,p:v||c===1?v:",",s:f,c:b-f,m:g&&g<4||t==="zIndex"?Math.round:0});a.c=l<n.length?n.substring(l,n.length):""}else a.r=t==="display"&&n==="none"?ed:Qu;return mu.test(n)&&(a.e=0),this._pt=a,a},uc={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},rg=function(e){var t=e.split(" "),i=t[0],n=t[1]||"50%";return(i==="top"||i==="bottom"||n==="left"||n==="right")&&(e=i,i=n,n=e),t[0]=uc[i]||i,t[1]=uc[n]||n,t.join(" ")},sg=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var i=t.t,n=i.style,r=t.u,o=i._gsap,a,l,c;if(r==="all"||r===!0)n.cssText="",l=1;else for(r=r.split(","),c=r.length;--c>-1;)a=r[c],Ci[a]&&(l=1,a=a==="transformOrigin"?wt:xe),Vi(i,a);l&&(Vi(i,xe),o&&(o.svg&&i.removeAttribute("transform"),n.scale=n.rotate=n.translate="none",Zr(i,1),o.uncache=1,td(n)))}},to={clearProps:function(e,t,i,n,r){if(r.data!=="isFromStart"){var o=e._pt=new xt(e._pt,t,i,0,0,sg);return o.u=n,o.pr=-10,o.tween=r,e._props.push(i),1}}},Jr=[1,0,0,1,0,0],od={},ad=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},dc=function(e){var t=zt(e,xe);return ad(t)?Jr:t.substr(7).match(gu).map(Le)},cl=function(e,t){var i=e._gsap||cn(e),n=e.style,r=dc(e),o,a,l,c;return i.svg&&e.getAttribute("transform")?(l=e.transform.baseVal.consolidate().matrix,r=[l.a,l.b,l.c,l.d,l.e,l.f],r.join(",")==="1,0,0,1,0,0"?Jr:r):(r===Jr&&!e.offsetParent&&e!==Bn&&!i.svg&&(l=n.display,n.display="block",o=e.parentNode,(!o||!e.offsetParent&&!e.getBoundingClientRect().width)&&(c=1,a=e.nextElementSibling,Bn.appendChild(e)),r=dc(e),l?n.display=l:Vi(e,"display"),c&&(a?o.insertBefore(e,a):o?o.appendChild(e):Bn.removeChild(e))),t&&r.length>6?[r[0],r[1],r[4],r[5],r[12],r[13]]:r)},ha=function(e,t,i,n,r,o){var a=e._gsap,l=r||cl(e,!0),c=a.xOrigin||0,u=a.yOrigin||0,d=a.xOffset||0,h=a.yOffset||0,f=l[0],g=l[1],p=l[2],_=l[3],b=l[4],v=l[5],x=t.split(" "),w=parseFloat(x[0])||0,S=parseFloat(x[1])||0,P,C,T,k;i?l!==Jr&&(C=f*_-g*p)&&(T=w*(_/C)+S*(-p/C)+(p*v-_*b)/C,k=w*(-g/C)+S*(f/C)-(f*v-g*b)/C,w=T,S=k):(P=rd(e),w=P.x+(~x[0].indexOf("%")?w/100*P.width:w),S=P.y+(~(x[1]||x[0]).indexOf("%")?S/100*P.height:S)),n||n!==!1&&a.smooth?(b=w-c,v=S-u,a.xOffset=d+(b*f+v*p)-b,a.yOffset=h+(b*g+v*_)-v):a.xOffset=a.yOffset=0,a.xOrigin=w,a.yOrigin=S,a.smooth=!!n,a.origin=t,a.originIsAbsolute=!!i,e.style[wt]="0px 0px",o&&(Di(o,a,"xOrigin",c,w),Di(o,a,"yOrigin",u,S),Di(o,a,"xOffset",d,a.xOffset),Di(o,a,"yOffset",h,a.yOffset)),e.setAttribute("data-svg-origin",w+" "+S)},Zr=function(e,t){var i=e._gsap||new Bu(e);if("x"in i&&!t&&!i.uncache)return i;var n=e.style,r=i.scaleX<0,o="px",a="deg",l=getComputedStyle(e),c=zt(e,wt)||"0",u,d,h,f,g,p,_,b,v,x,w,S,P,C,T,k,O,M,E,V,U,I,N,j,J,Y,y,K,Te,ge,ue,we;return u=d=h=p=_=b=v=x=w=0,f=g=1,i.svg=!!(e.getCTM&&sd(e)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(n[xe]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[xe]!=="none"?l[xe]:"")),n.scale=n.rotate=n.translate="none"),C=cl(e,i.svg),i.svg&&(i.uncache?(J=e.getBBox(),c=i.xOrigin-J.x+"px "+(i.yOrigin-J.y)+"px",j=""):j=!t&&e.getAttribute("data-svg-origin"),ha(e,j||c,!!j||i.originIsAbsolute,i.smooth!==!1,C)),S=i.xOrigin||0,P=i.yOrigin||0,C!==Jr&&(M=C[0],E=C[1],V=C[2],U=C[3],u=I=C[4],d=N=C[5],C.length===6?(f=Math.sqrt(M*M+E*E),g=Math.sqrt(U*U+V*V),p=M||E?zn(E,M)*tn:0,v=V||U?zn(V,U)*tn+p:0,v&&(g*=Math.abs(Math.cos(v*qn))),i.svg&&(u-=S-(S*M+P*V),d-=P-(S*E+P*U))):(we=C[6],ge=C[7],y=C[8],K=C[9],Te=C[10],ue=C[11],u=C[12],d=C[13],h=C[14],T=zn(we,Te),_=T*tn,T&&(k=Math.cos(-T),O=Math.sin(-T),j=I*k+y*O,J=N*k+K*O,Y=we*k+Te*O,y=I*-O+y*k,K=N*-O+K*k,Te=we*-O+Te*k,ue=ge*-O+ue*k,I=j,N=J,we=Y),T=zn(-V,Te),b=T*tn,T&&(k=Math.cos(-T),O=Math.sin(-T),j=M*k-y*O,J=E*k-K*O,Y=V*k-Te*O,ue=U*O+ue*k,M=j,E=J,V=Y),T=zn(E,M),p=T*tn,T&&(k=Math.cos(T),O=Math.sin(T),j=M*k+E*O,J=I*k+N*O,E=E*k-M*O,N=N*k-I*O,M=j,I=J),_&&Math.abs(_)+Math.abs(p)>359.9&&(_=p=0,b=180-b),f=Le(Math.sqrt(M*M+E*E+V*V)),g=Le(Math.sqrt(N*N+we*we)),T=zn(I,N),v=Math.abs(T)>2e-4?T*tn:0,w=ue?1/(ue<0?-ue:ue):0),i.svg&&(j=e.getAttribute("transform"),i.forceCSS=e.setAttribute("transform","")||!ad(zt(e,xe)),j&&e.setAttribute("transform",j))),Math.abs(v)>90&&Math.abs(v)<270&&(r?(f*=-1,v+=p<=0?180:-180,p+=p<=0?180:-180):(g*=-1,v+=v<=0?180:-180)),t=t||i.uncache,i.x=u-((i.xPercent=u&&(!t&&i.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-u)?-50:0)))?e.offsetWidth*i.xPercent/100:0)+o,i.y=d-((i.yPercent=d&&(!t&&i.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-d)?-50:0)))?e.offsetHeight*i.yPercent/100:0)+o,i.z=h+o,i.scaleX=Le(f),i.scaleY=Le(g),i.rotation=Le(p)+a,i.rotationX=Le(_)+a,i.rotationY=Le(b)+a,i.skewX=v+a,i.skewY=x+a,i.transformPerspective=w+o,(i.zOrigin=parseFloat(c.split(" ")[2])||!t&&i.zOrigin||0)&&(n[wt]=io(c)),i.xOffset=i.yOffset=0,i.force3D=Dt.force3D,i.renderTransform=i.svg?ag:nd?ld:og,i.uncache=0,i},io=function(e){return(e=e.split(" "))[0]+" "+e[1]},jo=function(e,t,i){var n=rt(t);return Le(parseFloat(t)+parseFloat(Bi(e,"x",i+"px",n)))+n},og=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,ld(e,t)},Zi="0deg",pr="0px",Qi=") ",ld=function(e,t){var i=t||this,n=i.xPercent,r=i.yPercent,o=i.x,a=i.y,l=i.z,c=i.rotation,u=i.rotationY,d=i.rotationX,h=i.skewX,f=i.skewY,g=i.scaleX,p=i.scaleY,_=i.transformPerspective,b=i.force3D,v=i.target,x=i.zOrigin,w="",S=b==="auto"&&e&&e!==1||b===!0;if(x&&(d!==Zi||u!==Zi)){var P=parseFloat(u)*qn,C=Math.sin(P),T=Math.cos(P),k;P=parseFloat(d)*qn,k=Math.cos(P),o=jo(v,o,C*k*-x),a=jo(v,a,-Math.sin(P)*-x),l=jo(v,l,T*k*-x+x)}_!==pr&&(w+="perspective("+_+Qi),(n||r)&&(w+="translate("+n+"%, "+r+"%) "),(S||o!==pr||a!==pr||l!==pr)&&(w+=l!==pr||S?"translate3d("+o+", "+a+", "+l+") ":"translate("+o+", "+a+Qi),c!==Zi&&(w+="rotate("+c+Qi),u!==Zi&&(w+="rotateY("+u+Qi),d!==Zi&&(w+="rotateX("+d+Qi),(h!==Zi||f!==Zi)&&(w+="skew("+h+", "+f+Qi),(g!==1||p!==1)&&(w+="scale("+g+", "+p+Qi),v.style[xe]=w||"translate(0, 0)"},ag=function(e,t){var i=t||this,n=i.xPercent,r=i.yPercent,o=i.x,a=i.y,l=i.rotation,c=i.skewX,u=i.skewY,d=i.scaleX,h=i.scaleY,f=i.target,g=i.xOrigin,p=i.yOrigin,_=i.xOffset,b=i.yOffset,v=i.forceCSS,x=parseFloat(o),w=parseFloat(a),S,P,C,T,k;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=qn,c*=qn,S=Math.cos(l)*d,P=Math.sin(l)*d,C=Math.sin(l-c)*-h,T=Math.cos(l-c)*h,c&&(u*=qn,k=Math.tan(c-u),k=Math.sqrt(1+k*k),C*=k,T*=k,u&&(k=Math.tan(u),k=Math.sqrt(1+k*k),S*=k,P*=k)),S=Le(S),P=Le(P),C=Le(C),T=Le(T)):(S=d,T=h,P=C=0),(x&&!~(o+"").indexOf("px")||w&&!~(a+"").indexOf("px"))&&(x=Bi(f,"x",o,"px"),w=Bi(f,"y",a,"px")),(g||p||_||b)&&(x=Le(x+g-(g*S+p*C)+_),w=Le(w+p-(g*P+p*T)+b)),(n||r)&&(k=f.getBBox(),x=Le(x+n/100*k.width),w=Le(w+r/100*k.height)),k="matrix("+S+","+P+","+C+","+T+","+x+","+w+")",f.setAttribute("transform",k),v&&(f.style[xe]=k)},lg=function(e,t,i,n,r){var o=360,a=Ye(r),l=parseFloat(r)*(a&&~r.indexOf("rad")?tn:1),c=l-n,u=n+c+"deg",d,h;return a&&(d=r.split("_")[1],d==="short"&&(c%=o,c!==c%(o/2)&&(c+=c<0?o:-o)),d==="cw"&&c<0?c=(c+o*sc)%o-~~(c/o)*o:d==="ccw"&&c>0&&(c=(c-o*sc)%o-~~(c/o)*o)),e._pt=h=new xt(e._pt,t,i,n,c,Bp),h.e=u,h.u="deg",e._props.push(i),h},hc=function(e,t){for(var i in t)e[i]=t[i];return e},cg=function(e,t,i){var n=hc({},i._gsap),r="perspective,force3D,transformOrigin,svgOrigin",o=i.style,a,l,c,u,d,h,f,g;n.svg?(c=i.getAttribute("transform"),i.setAttribute("transform",""),o[xe]=t,a=Zr(i,1),Vi(i,xe),i.setAttribute("transform",c)):(c=getComputedStyle(i)[xe],o[xe]=t,a=Zr(i,1),o[xe]=c);for(l in Ci)c=n[l],u=a[l],c!==u&&r.indexOf(l)<0&&(f=rt(c),g=rt(u),d=f!==g?Bi(i,l,c,g):parseFloat(c),h=parseFloat(u),e._pt=new xt(e._pt,a,l,d,h-d,ca),e._pt.u=g||0,e._props.push(l));hc(a,n)};yt("padding,margin,Width,Radius",function(s,e){var t="Top",i="Right",n="Bottom",r="Left",o=(e<3?[t,i,n,r]:[t+r,t+i,n+i,n+r]).map(function(a){return e<2?s+a:"border"+a+s});to[e>1?"border"+s:s]=function(a,l,c,u,d){var h,f;if(arguments.length<4)return h=o.map(function(g){return _i(a,g,c)}),f=h.join(" "),f.split(h[0]).length===5?h[0]:f;h=(u+"").split(" "),f={},o.forEach(function(g,p){return f[g]=h[p]=h[p]||h[(p-1)/2|0]}),a.init(l,f,d)}});var cd={name:"css",register:da,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,i,n,r){var o=this._props,a=e.style,l=i.vars.startAt,c,u,d,h,f,g,p,_,b,v,x,w,S,P,C,T,k;ol||da(),this.styles=this.styles||id(e),T=this.styles.props,this.tween=i;for(p in t)if(p!=="autoRound"&&(u=t[p],!(Ot[p]&&qu(p,t,i,n,e,r)))){if(f=typeof u,g=to[p],f==="function"&&(u=u.call(i,n,e,r),f=typeof u),f==="string"&&~u.indexOf("random(")&&(u=Xr(u)),g)g(this,e,p,u,i)&&(C=1);else if(p.substr(0,2)==="--")c=(getComputedStyle(e).getPropertyValue(p)+"").trim(),u+="",Ni.lastIndex=0,Ni.test(c)||(_=rt(c),b=rt(u),b?_!==b&&(c=Bi(e,p,c,b)+b):_&&(u+=_)),this.add(a,"setProperty",c,u,n,r,0,0,p),o.push(p),T.push(p,0,a[p]);else if(f!=="undefined"){if(l&&p in l?(c=typeof l[p]=="function"?l[p].call(i,n,e,r):l[p],Ye(c)&&~c.indexOf("random(")&&(c=Xr(c)),rt(c+"")||c==="auto"||(c+=Dt.units[p]||rt(_i(e,p))||""),(c+"").charAt(1)==="="&&(c=_i(e,p))):c=_i(e,p),h=parseFloat(c),v=f==="string"&&u.charAt(1)==="="&&u.substr(0,2),v&&(u=u.substr(2)),d=parseFloat(u),p in ri&&(p==="autoAlpha"&&(h===1&&_i(e,"visibility")==="hidden"&&d&&(h=0),T.push("visibility",0,a.visibility),Di(this,a,"visibility",h?"inherit":"hidden",d?"inherit":"hidden",!d)),p!=="scale"&&p!=="transform"&&(p=ri[p],~p.indexOf(",")&&(p=p.split(",")[0]))),x=p in Ci,x){if(this.styles.save(p),k=u,f==="string"&&u.substring(0,6)==="var(--"){if(u=zt(e,u.substring(4,u.indexOf(")"))),u.substring(0,5)==="calc("){var O=e.style.perspective;e.style.perspective=u,u=zt(e,"perspective"),O?e.style.perspective=O:Vi(e,"perspective")}d=parseFloat(u)}if(w||(S=e._gsap,S.renderTransform&&!t.parseTransform||Zr(e,t.parseTransform),P=t.smoothOrigin!==!1&&S.smooth,w=this._pt=new xt(this._pt,a,xe,0,1,S.renderTransform,S,0,-1),w.dep=1),p==="scale")this._pt=new xt(this._pt,S,"scaleY",S.scaleY,(v?Vn(S.scaleY,v+d):d)-S.scaleY||0,ca),this._pt.u=0,o.push("scaleY",p),p+="X";else if(p==="transformOrigin"){T.push(wt,0,a[wt]),u=rg(u),S.svg?ha(e,u,0,P,0,this):(b=parseFloat(u.split(" ")[2])||0,b!==S.zOrigin&&Di(this,S,"zOrigin",S.zOrigin,b),Di(this,a,p,io(c),io(u)));continue}else if(p==="svgOrigin"){ha(e,u,1,P,0,this);continue}else if(p in od){lg(this,S,p,h,v?Vn(h,v+u):u);continue}else if(p==="smoothOrigin"){Di(this,S,"smooth",S.smooth,u);continue}else if(p==="force3D"){S[p]=u;continue}else if(p==="transform"){cg(this,u,e);continue}}else p in a||(p=er(p)||p);if(x||(d||d===0)&&(h||h===0)&&!Vp.test(u)&&p in a)_=(c+"").substr((h+"").length),d||(d=0),b=rt(u)||(p in Dt.units?Dt.units[p]:_),_!==b&&(h=Bi(e,p,c,b)),this._pt=new xt(this._pt,x?S:a,p,h,(v?Vn(h,v+d):d)-h,!x&&(b==="px"||p==="zIndex")&&t.autoRound!==!1?Yp:ca),this._pt.u=b||0,x&&k!==u?(this._pt.b=c,this._pt.e=k,this._pt.r=Wp):_!==b&&b!=="%"&&(this._pt.b=c,this._pt.r=qp);else if(p in a)ng.call(this,e,p,c,v?v+u:u);else if(p in e)this.add(e,p,c||e[p],v?v+u:u,n,r);else if(p!=="parseTransform"){Ka(p,u);continue}x||(p in a?T.push(p,0,a[p]):typeof e[p]=="function"?T.push(p,2,e[p]()):T.push(p,1,c||e[p])),o.push(p)}}C&&Ju(this)},render:function(e,t){if(t.tween._time||!al())for(var i=t._pt;i;)i.r(e,i.d),i=i._next;else t.styles.revert()},get:_i,aliases:ri,getSetter:function(e,t,i){var n=ri[t];return n&&n.indexOf(",")<0&&(t=n),t in Ci&&t!==wt&&(e._gsap.x||_i(e,"x"))?i&&rc===i?t==="scale"?Jp:Kp:(rc=i||{})&&(t==="scale"?Zp:Qp):e.style&&!Ya(e.style[t])?Xp:~t.indexOf("-")?Gp:rl(e,t)},core:{_removeProperty:Vi,_getMatrix:cl}};Ct.utils.checkPrefix=er;Ct.core.getStyleSaver=id;(function(s,e,t,i){var n=yt(s+","+e+","+t,function(r){Ci[r]=1});yt(e,function(r){Dt.units[r]="deg",od[r]=1}),ri[n[13]]=s+","+e,yt(i,function(r){var o=r.split(":");ri[o[1]]=n[o[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");yt("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(s){Dt.units[s]="px"});Ct.registerPlugin(cd);var oe=Ct.registerPlugin(cd)||Ct;oe.core.Tween;/*!
 * paths 3.14.2
 * https://gsap.com
 *
 * Copyright 2008-2025, GreenSock. All rights reserved.
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var ug=/[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/ig,dg=/[\+\-]?\d*\.?\d+e[\+\-]?\d+/ig,hg=Math.PI/180,_s=Math.sin,vs=Math.cos,Ar=Math.abs,gr=Math.sqrt,fg=function(e){return typeof e=="number"},fc=1e5,Ei=function(e){return Math.round(e*fc)/fc||0},pc=function(e){return e.closed=Math.abs(e[0]-e[e.length-2])<.001&&Math.abs(e[1]-e[e.length-1])<.001};function pg(s,e,t,i,n,r,o){for(var a=s.length,l,c,u,d,h;--a>-1;)for(l=s[a],c=l.length,u=0;u<c;u+=2)d=l[u],h=l[u+1],l[u]=d*e+h*i+r,l[u+1]=d*t+h*n+o;return s._dirty=1,s}function gg(s,e,t,i,n,r,o,a,l){if(!(s===a&&e===l)){t=Ar(t),i=Ar(i);var c=n%360*hg,u=vs(c),d=_s(c),h=Math.PI,f=h*2,g=(s-a)/2,p=(e-l)/2,_=u*g+d*p,b=-d*g+u*p,v=_*_,x=b*b,w=v/(t*t)+x/(i*i);w>1&&(t=gr(w)*t,i=gr(w)*i);var S=t*t,P=i*i,C=(S*P-S*x-P*v)/(S*x+P*v);C<0&&(C=0);var T=(r===o?-1:1)*gr(C),k=T*(t*b/i),O=T*-(i*_/t),M=(s+a)/2,E=(e+l)/2,V=M+(u*k-d*O),U=E+(d*k+u*O),I=(_-k)/t,N=(b-O)/i,j=(-_-k)/t,J=(-b-O)/i,Y=I*I+N*N,y=(N<0?-1:1)*Math.acos(I/gr(Y)),K=(I*J-N*j<0?-1:1)*Math.acos((I*j+N*J)/gr(Y*(j*j+J*J)));isNaN(K)&&(K=h),!o&&K>0?K-=f:o&&K<0&&(K+=f),y%=f,K%=f;var Te=Math.ceil(Ar(K)/(f/4)),ge=[],ue=K/Te,we=4/3*_s(ue/2)/(1+vs(ue/2)),Ue=u*t,Ce=d*t,Xe=d*-i,He=u*i,Se;for(Se=0;Se<Te;Se++)n=y+Se*ue,_=vs(n),b=_s(n),I=vs(n+=ue),N=_s(n),ge.push(_-we*b,b+we*_,I+we*N,N-we*I,I,N);for(Se=0;Se<ge.length;Se+=2)_=ge[Se],b=ge[Se+1],ge[Se]=_*Ue+b*Xe+V,ge[Se+1]=_*Ce+b*He+U;return ge[Se-2]=a,ge[Se-1]=l,ge}}function mg(s){var e=(s+"").replace(dg,function(k){var O=+k;return O<1e-4&&O>-1e-4?0:O}).match(ug)||[],t=[],i=0,n=0,r=2/3,o=e.length,a=0,l="ERROR: malformed path: "+s,c,u,d,h,f,g,p,_,b,v,x,w,S,P,C,T=function(O,M,E,V){v=(E-O)/3,x=(V-M)/3,p.push(O+v,M+x,E-v,V-x,E,V)};if(!s||!isNaN(e[0])||isNaN(e[1]))return console.log(l),t;for(c=0;c<o;c++)if(S=f,isNaN(e[c])?(f=e[c].toUpperCase(),g=f!==e[c]):c--,d=+e[c+1],h=+e[c+2],g&&(d+=i,h+=n),c||(_=d,b=h),f==="M")p&&(p.length<8?t.length-=1:a+=p.length,pc(p)),i=_=d,n=b=h,p=[d,h],t.push(p),c+=2,f="L";else if(f==="C")p||(p=[0,0]),g||(i=n=0),p.push(d,h,i+e[c+3]*1,n+e[c+4]*1,i+=e[c+5]*1,n+=e[c+6]*1),c+=6;else if(f==="S")v=i,x=n,(S==="C"||S==="S")&&(v+=i-p[p.length-4],x+=n-p[p.length-3]),g||(i=n=0),p.push(v,x,d,h,i+=e[c+3]*1,n+=e[c+4]*1),c+=4;else if(f==="Q")v=i+(d-i)*r,x=n+(h-n)*r,g||(i=n=0),i+=e[c+3]*1,n+=e[c+4]*1,p.push(v,x,i+(d-i)*r,n+(h-n)*r,i,n),c+=4;else if(f==="T")v=i-p[p.length-4],x=n-p[p.length-3],p.push(i+v,n+x,d+(i+v*1.5-d)*r,h+(n+x*1.5-h)*r,i=d,n=h),c+=2;else if(f==="H")T(i,n,i=d,n),c+=1;else if(f==="V")T(i,n,i,n=d+(g?n-i:0)),c+=1;else if(f==="L"||f==="Z")f==="Z"&&(d=_,h=b,p.closed=!0),(f==="L"||Ar(i-d)>.5||Ar(n-h)>.5)&&(T(i,n,d,h),f==="L"&&(c+=2)),i=d,n=h;else if(f==="A"){if(P=e[c+4],C=e[c+5],v=e[c+6],x=e[c+7],u=7,P.length>1&&(P.length<3?(x=v,v=C,u--):(x=C,v=P.substr(2),u-=2),C=P.charAt(1),P=P.charAt(0)),w=gg(i,n,+e[c+1],+e[c+2],+e[c+3],+P,+C,(g?i:0)+v*1,(g?n:0)+x*1),c+=u,w)for(u=0;u<w.length;u++)p.push(w[u]);i=p[p.length-2],n=p[p.length-1]}else console.log(l);return c=p.length,c<6?(t.pop(),c=0):pc(p),t.totalPoints=a+c,t}function _g(s){fg(s[0])&&(s=[s]);var e="",t=s.length,i,n,r,o;for(n=0;n<t;n++){for(o=s[n],e+="M"+Ei(o[0])+","+Ei(o[1])+" C",i=o.length,r=2;r<i;r++)e+=Ei(o[r++])+","+Ei(o[r++])+" "+Ei(o[r++])+","+Ei(o[r++])+" "+Ei(o[r++])+","+Ei(o[r])+" ";o.closed&&(e+="z")}return e}/*!
 * CustomEase 3.14.2
 * https://gsap.com
 *
 * @license Copyright 2008-2025, GreenSock. All rights reserved.
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var vt,ud,dd=function(){return vt||typeof window<"u"&&(vt=window.gsap)&&vt.registerPlugin&&vt},gc=function(){vt=dd(),vt?(vt.registerEase("_CE",sr.create),ud=1):console.warn("Please gsap.registerPlugin(CustomEase)")},vg=1e20,bs=function(e){return~~(e*1e3+(e<0?-.5:.5))/1e3},bg=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/gi,yg=/[cLlsSaAhHvVtTqQ]/g,xg=function(e){var t=e.length,i=vg,n;for(n=1;n<t;n+=6)+e[n]<i&&(i=+e[n]);return i},wg=function(e,t,i){!i&&i!==0&&(i=Math.max(+e[e.length-1],+e[1]));var n=+e[0]*-1,r=-i,o=e.length,a=1/(+e[o-2]+n),l=-t||(Math.abs(+e[o-1]-+e[1])<.01*(+e[o-2]-+e[0])?xg(e)+r:+e[o-1]+r),c;for(l?l=1/l:l=-a,c=0;c<o;c+=2)e[c]=(+e[c]+n)*a,e[c+1]=(+e[c+1]+r)*l},Cg=function s(e,t,i,n,r,o,a,l,c,u,d){var h=(e+i)/2,f=(t+n)/2,g=(i+r)/2,p=(n+o)/2,_=(r+a)/2,b=(o+l)/2,v=(h+g)/2,x=(f+p)/2,w=(g+_)/2,S=(p+b)/2,P=(v+w)/2,C=(x+S)/2,T=a-e,k=l-t,O=Math.abs((i-a)*k-(n-l)*T),M=Math.abs((r-a)*k-(o-l)*T),E;return u||(u=[{x:e,y:t},{x:a,y:l}],d=1),u.splice(d||u.length-1,0,{x:P,y:C}),(O+M)*(O+M)>c*(T*T+k*k)&&(E=u.length,s(e,t,h,f,v,x,P,C,c,u,d),s(P,C,w,S,_,b,a,l,c,u,d+1+(u.length-E))),u},sr=(function(){function s(t,i,n){ud||gc(),this.id=t,this.setData(i,n)}var e=s.prototype;return e.setData=function(i,n){n=n||{},i=i||"0,0,1,1";var r=i.match(bg),o=1,a=[],l=[],c=n.precision||1,u=c<=1,d,h,f,g,p,_,b,v,x;if(this.data=i,(yg.test(i)||~i.indexOf("M")&&i.indexOf("C")<0)&&(r=mg(i)[0]),d=r.length,d===4)r.unshift(0,0),r.push(1,1),d=8;else if((d-2)%6)throw"Invalid CustomEase";for((+r[0]!=0||+r[d-2]!=1)&&wg(r,n.height,n.originY),this.segment=r,g=2;g<d;g+=6)h={x:+r[g-2],y:+r[g-1]},f={x:+r[g+4],y:+r[g+5]},a.push(h,f),Cg(h.x,h.y,+r[g],+r[g+1],+r[g+2],+r[g+3],f.x,f.y,1/(c*2e5),a,a.length-1);for(d=a.length,g=0;g<d;g++)b=a[g],v=a[g-1]||b,(b.x>v.x||v.y!==b.y&&v.x===b.x||b===v)&&b.x<=1?(v.cx=b.x-v.x,v.cy=b.y-v.y,v.n=b,v.nx=b.x,u&&g>1&&Math.abs(v.cy/v.cx-a[g-2].cy/a[g-2].cx)>2&&(u=0),v.cx<o&&(v.cx?o=v.cx:(v.cx=.001,g===d-1&&(v.x-=.001,o=Math.min(o,.001),u=0)))):(a.splice(g--,1),d--);if(d=1/o+1|0,p=1/d,_=0,b=a[0],u){for(g=0;g<d;g++)x=g*p,b.nx<x&&(b=a[++_]),h=b.y+(x-b.x)/b.cx*b.cy,l[g]={x,cx:p,y:h,cy:0,nx:9},g&&(l[g-1].cy=h-l[g-1].y);_=a[a.length-1],l[d-1].cy=_.y-h,l[d-1].cx=_.x-l[l.length-1].x}else{for(g=0;g<d;g++)b.nx<g*p&&(b=a[++_]),l[g]=b;_<a.length-1&&(l[g-1]=a[a.length-2])}return this.ease=function(w){var S=l[w*d|0]||l[d-1];return S.nx<w&&(S=S.n),S.y+(w-S.x)/S.cx*S.cy},this.ease.custom=this,this.id&&vt&&vt.registerEase(this.id,this.ease),this},e.getSVGData=function(i){return s.getSVGData(this,i)},s.create=function(i,n,r){return new s(i,n,r).ease},s.register=function(i){vt=i,gc()},s.get=function(i){return vt.parseEase(i)},s.getSVGData=function(i,n){n=n||{};var r=n.width||100,o=n.height||100,a=n.x||0,l=(n.y||0)+o,c=vt.utils.toArray(n.path)[0],u,d,h,f,g,p,_,b,v,x;if(n.invert&&(o=-o,l=0),typeof i=="string"&&(i=vt.parseEase(i)),i.custom&&(i=i.custom),i instanceof s)u=_g(pg([i.segment.slice(0)],r,0,0,-o,a,l));else{for(u=[a,l],_=Math.max(5,(n.precision||1)*200),f=1/_,_+=2,b=5/_,v=bs(a+f*r),x=bs(l+i(f)*-o),d=(x-l)/(v-a),h=2;h<_;h++)g=bs(a+h*f*r),p=bs(l+i(h*f)*-o),(Math.abs((p-x)/(g-v)-d)>b||h===_-1)&&(u.push(v,x),d=(p-x)/(g-v)),v=g,x=p;u="M"+u.join(",")}return c&&c.setAttribute("d",u),u},s})();sr.version="3.14.2";sr.headless=!0;dd()&&vt.registerPlugin(sr);function Sg(s,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(s,i.key,i)}}function $g(s,e,t){return e&&Sg(s.prototype,e),s}/*!
 * Observer 3.14.2
 * https://gsap.com
 *
 * @license Copyright 2008-2025, GreenSock. All rights reserved.
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var Je,js,Lt,Ri,ji,Wn,hd,nn,Lr,fd,bi,Kt,pd,gd=function(){return Je||typeof window<"u"&&(Je=window.gsap)&&Je.registerPlugin&&Je},md=1,Hn=[],te=[],ai=[],Mr=Date.now,fa=function(e,t){return t},Pg=function(){var e=Lr.core,t=e.bridge||{},i=e._scrollers,n=e._proxies;i.push.apply(i,te),n.push.apply(n,ai),te=i,ai=n,fa=function(o,a){return t[o](a)}},Fi=function(e,t){return~ai.indexOf(e)&&ai[ai.indexOf(e)+1][t]},zr=function(e){return!!~fd.indexOf(e)},ut=function(e,t,i,n,r){return e.addEventListener(t,i,{passive:n!==!1,capture:!!r})},ct=function(e,t,i,n){return e.removeEventListener(t,i,!!n)},ys="scrollLeft",xs="scrollTop",pa=function(){return bi&&bi.isPressed||te.cache++},no=function(e,t){var i=function n(r){if(r||r===0){md&&(Lt.history.scrollRestoration="manual");var o=bi&&bi.isPressed;r=n.v=Math.round(r)||(bi&&bi.iOS?1:0),e(r),n.cacheID=te.cache,o&&fa("ss",r)}else(t||te.cache!==n.cacheID||fa("ref"))&&(n.cacheID=te.cache,n.v=e());return n.v+n.offset};return i.offset=0,e&&i},gt={s:ys,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:no(function(s){return arguments.length?Lt.scrollTo(s,Fe.sc()):Lt.pageXOffset||Ri[ys]||ji[ys]||Wn[ys]||0})},Fe={s:xs,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:gt,sc:no(function(s){return arguments.length?Lt.scrollTo(gt.sc(),s):Lt.pageYOffset||Ri[xs]||ji[xs]||Wn[xs]||0})},_t=function(e,t){return(t&&t._ctx&&t._ctx.selector||Je.utils.toArray)(e)[0]||(typeof e=="string"&&Je.config().nullTargetWarn!==!1?console.warn("Element not found:",e):null)},kg=function(e,t){for(var i=t.length;i--;)if(t[i]===e||t[i].contains(e))return!0;return!1},qi=function(e,t){var i=t.s,n=t.sc;zr(e)&&(e=Ri.scrollingElement||ji);var r=te.indexOf(e),o=n===Fe.sc?1:2;!~r&&(r=te.push(e)-1),te[r+o]||ut(e,"scroll",pa);var a=te[r+o],l=a||(te[r+o]=no(Fi(e,i),!0)||(zr(e)?n:no(function(c){return arguments.length?e[i]=c:e[i]})));return l.target=e,a||(l.smooth=Je.getProperty(e,"scrollBehavior")==="smooth"),l},ga=function(e,t,i){var n=e,r=e,o=Mr(),a=o,l=t||50,c=Math.max(500,l*3),u=function(g,p){var _=Mr();p||_-o>l?(r=n,n=g,a=o,o=_):i?n+=g:n=r+(g-r)/(_-a)*(o-a)},d=function(){r=n=i?0:n,a=o=0},h=function(g){var p=a,_=r,b=Mr();return(g||g===0)&&g!==n&&u(g),o===a||b-a>c?0:(n+(i?_:-_))/((i?b:o)-p)*1e3};return{update:u,reset:d,getVelocity:h}},mr=function(e,t){return t&&!e._gsapAllow&&e.preventDefault(),e.changedTouches?e.changedTouches[0]:e},mc=function(e){var t=Math.max.apply(Math,e),i=Math.min.apply(Math,e);return Math.abs(t)>=Math.abs(i)?t:i},_d=function(){Lr=Je.core.globals().ScrollTrigger,Lr&&Lr.core&&Pg()},vd=function(e){return Je=e||gd(),!js&&Je&&typeof document<"u"&&document.body&&(Lt=window,Ri=document,ji=Ri.documentElement,Wn=Ri.body,fd=[Lt,Ri,ji,Wn],Je.utils.clamp,pd=Je.core.context||function(){},nn="onpointerenter"in Wn?"pointer":"mouse",hd=ze.isTouch=Lt.matchMedia&&Lt.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in Lt||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,Kt=ze.eventTypes=("ontouchstart"in ji?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in ji?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return md=0},500),_d(),js=1),js};gt.op=Fe;te.cache=0;var ze=(function(){function s(t){this.init(t)}var e=s.prototype;return e.init=function(i){js||vd(Je)||console.warn("Please gsap.registerPlugin(Observer)"),Lr||_d();var n=i.tolerance,r=i.dragMinimum,o=i.type,a=i.target,l=i.lineHeight,c=i.debounce,u=i.preventDefault,d=i.onStop,h=i.onStopDelay,f=i.ignore,g=i.wheelSpeed,p=i.event,_=i.onDragStart,b=i.onDragEnd,v=i.onDrag,x=i.onPress,w=i.onRelease,S=i.onRight,P=i.onLeft,C=i.onUp,T=i.onDown,k=i.onChangeX,O=i.onChangeY,M=i.onChange,E=i.onToggleX,V=i.onToggleY,U=i.onHover,I=i.onHoverEnd,N=i.onMove,j=i.ignoreCheck,J=i.isNormalizer,Y=i.onGestureStart,y=i.onGestureEnd,K=i.onWheel,Te=i.onEnable,ge=i.onDisable,ue=i.onClick,we=i.scrollSpeed,Ue=i.capture,Ce=i.allowClicks,Xe=i.lockAxis,He=i.onLockAxis;this.target=a=_t(a)||ji,this.vars=i,f&&(f=Je.utils.toArray(f)),n=n||1e-9,r=r||0,g=g||1,we=we||1,o=o||"wheel,touch,pointer",c=c!==!1,l||(l=parseFloat(Lt.getComputedStyle(Wn).lineHeight)||22);var Se,at,lt,ae,Oe,mt,St,$=this,$t=0,di=0,Si=i.passive||!u&&i.passive!==!1,$e=qi(a,gt),hi=qi(a,Fe),$i=$e(),Yi=hi(),Ve=~o.indexOf("touch")&&!~o.indexOf("pointer")&&Kt[0]==="pointerdown",Pi=zr(a),Ee=a.ownerDocument||Ri,qt=[0,0,0],It=[0,0,0],fi=0,cr=function(){return fi=Mr()},De=function(H,le){return($.event=H)&&f&&kg(H.target,f)||le&&Ve&&H.pointerType!=="touch"||j&&j(H,le)},hs=function(){$._vx.reset(),$._vy.reset(),at.pause(),d&&d($)},pi=function(){var H=$.deltaX=mc(qt),le=$.deltaY=mc(It),A=Math.abs(H)>=n,q=Math.abs(le)>=n;M&&(A||q)&&M($,H,le,qt,It),A&&(S&&$.deltaX>0&&S($),P&&$.deltaX<0&&P($),k&&k($),E&&$.deltaX<0!=$t<0&&E($),$t=$.deltaX,qt[0]=qt[1]=qt[2]=0),q&&(T&&$.deltaY>0&&T($),C&&$.deltaY<0&&C($),O&&O($),V&&$.deltaY<0!=di<0&&V($),di=$.deltaY,It[0]=It[1]=It[2]=0),(ae||lt)&&(N&&N($),lt&&(_&&lt===1&&_($),v&&v($),lt=0),ae=!1),mt&&!(mt=!1)&&He&&He($),Oe&&(K($),Oe=!1),Se=0},kn=function(H,le,A){qt[A]+=H,It[A]+=le,$._vx.update(H),$._vy.update(le),c?Se||(Se=requestAnimationFrame(pi)):pi()},Tn=function(H,le){Xe&&!St&&($.axis=St=Math.abs(H)>Math.abs(le)?"x":"y",mt=!0),St!=="y"&&(qt[2]+=H,$._vx.update(H,!0)),St!=="x"&&(It[2]+=le,$._vy.update(le,!0)),c?Se||(Se=requestAnimationFrame(pi)):pi()},ki=function(H){if(!De(H,1)){H=mr(H,u);var le=H.clientX,A=H.clientY,q=le-$.x,F=A-$.y,W=$.isDragging;$.x=le,$.y=A,(W||(q||F)&&(Math.abs($.startX-le)>=r||Math.abs($.startY-A)>=r))&&(lt||(lt=W?2:1),W||($.isDragging=!0),Tn(q,F))}},Xi=$.onPress=function(X){De(X,1)||X&&X.button||($.axis=St=null,at.pause(),$.isPressed=!0,X=mr(X),$t=di=0,$.startX=$.x=X.clientX,$.startY=$.y=X.clientY,$._vx.reset(),$._vy.reset(),ut(J?a:Ee,Kt[1],ki,Si,!0),$.deltaX=$.deltaY=0,x&&x($))},ne=$.onRelease=function(X){if(!De(X,1)){ct(J?a:Ee,Kt[1],ki,!0);var H=!isNaN($.y-$.startY),le=$.isDragging,A=le&&(Math.abs($.x-$.startX)>3||Math.abs($.y-$.startY)>3),q=mr(X);!A&&H&&($._vx.reset(),$._vy.reset(),u&&Ce&&Je.delayedCall(.08,function(){if(Mr()-fi>300&&!X.defaultPrevented){if(X.target.click)X.target.click();else if(Ee.createEvent){var F=Ee.createEvent("MouseEvents");F.initMouseEvent("click",!0,!0,Lt,1,q.screenX,q.screenY,q.clientX,q.clientY,!1,!1,!1,!1,0,null),X.target.dispatchEvent(F)}}})),$.isDragging=$.isGesturing=$.isPressed=!1,d&&le&&!J&&at.restart(!0),lt&&pi(),b&&le&&b($),w&&w($,A)}},Gi=function(H){return H.touches&&H.touches.length>1&&($.isGesturing=!0)&&Y(H,$.isDragging)},Wt=function(){return($.isGesturing=!1)||y($)},Yt=function(H){if(!De(H)){var le=$e(),A=hi();kn((le-$i)*we,(A-Yi)*we,1),$i=le,Yi=A,d&&at.restart(!0)}},Xt=function(H){if(!De(H)){H=mr(H,u),K&&(Oe=!0);var le=(H.deltaMode===1?l:H.deltaMode===2?Lt.innerHeight:1)*g;kn(H.deltaX*le,H.deltaY*le,0),d&&!J&&at.restart(!0)}},Ki=function(H){if(!De(H)){var le=H.clientX,A=H.clientY,q=le-$.x,F=A-$.y;$.x=le,$.y=A,ae=!0,d&&at.restart(!0),(q||F)&&Tn(q,F)}},On=function(H){$.event=H,U($)},gi=function(H){$.event=H,I($)},ur=function(H){return De(H)||mr(H,u)&&ue($)};at=$._dc=Je.delayedCall(h||.25,hs).pause(),$.deltaX=$.deltaY=0,$._vx=ga(0,50,!0),$._vy=ga(0,50,!0),$.scrollX=$e,$.scrollY=hi,$.isDragging=$.isGesturing=$.isPressed=!1,pd(this),$.enable=function(X){return $.isEnabled||(ut(Pi?Ee:a,"scroll",pa),o.indexOf("scroll")>=0&&ut(Pi?Ee:a,"scroll",Yt,Si,Ue),o.indexOf("wheel")>=0&&ut(a,"wheel",Xt,Si,Ue),(o.indexOf("touch")>=0&&hd||o.indexOf("pointer")>=0)&&(ut(a,Kt[0],Xi,Si,Ue),ut(Ee,Kt[2],ne),ut(Ee,Kt[3],ne),Ce&&ut(a,"click",cr,!0,!0),ue&&ut(a,"click",ur),Y&&ut(Ee,"gesturestart",Gi),y&&ut(Ee,"gestureend",Wt),U&&ut(a,nn+"enter",On),I&&ut(a,nn+"leave",gi),N&&ut(a,nn+"move",Ki)),$.isEnabled=!0,$.isDragging=$.isGesturing=$.isPressed=ae=lt=!1,$._vx.reset(),$._vy.reset(),$i=$e(),Yi=hi(),X&&X.type&&Xi(X),Te&&Te($)),$},$.disable=function(){$.isEnabled&&(Hn.filter(function(X){return X!==$&&zr(X.target)}).length||ct(Pi?Ee:a,"scroll",pa),$.isPressed&&($._vx.reset(),$._vy.reset(),ct(J?a:Ee,Kt[1],ki,!0)),ct(Pi?Ee:a,"scroll",Yt,Ue),ct(a,"wheel",Xt,Ue),ct(a,Kt[0],Xi,Ue),ct(Ee,Kt[2],ne),ct(Ee,Kt[3],ne),ct(a,"click",cr,!0),ct(a,"click",ur),ct(Ee,"gesturestart",Gi),ct(Ee,"gestureend",Wt),ct(a,nn+"enter",On),ct(a,nn+"leave",gi),ct(a,nn+"move",Ki),$.isEnabled=$.isPressed=$.isDragging=!1,ge&&ge($))},$.kill=$.revert=function(){$.disable();var X=Hn.indexOf($);X>=0&&Hn.splice(X,1),bi===$&&(bi=0)},Hn.push($),J&&zr(a)&&(bi=$),$.enable(p)},$g(s,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),s})();ze.version="3.14.2";ze.create=function(s){return new ze(s)};ze.register=vd;ze.getAll=function(){return Hn.slice()};ze.getById=function(s){return Hn.filter(function(e){return e.vars.id===s})[0]};gd()&&Je.registerPlugin(ze);/*!
 ...
 */class $a extends bm{constructor(e){if(super(e),this.it=Me,e.type!==_m.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===Me||e==null)return this._t=void 0,this.it=e;if(e===xn)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}}$a.directiveName="unsafeHTML",$a.resultType=1;const ci=vm($a);var ym=Object.defineProperty,xm=Object.getOwnPropertyDescriptor,Kd=(s,e,t,i)=>{for(var n=i>1?void 0:i?xm(e,t):e,r=s.length-1,o;r>=0;r--)(o=s[r])&&(n=(i?o(e,t,n):o(n))||n);return i&&n&&ym(e,t,n),n};let Pa=class extends G{constructor(){super(...arguments),this.lang=m.language,this.handleLanguageChange=()=>{this.lang=m.language}}connectedCallback(){super.connectedCallback(),m.on("languageChanged",this.handleLanguageChange)}disconnectedCallback(){super.disconnectedCallback(),m.off("languageChanged",this.handleLanguageChange)}render(){return R`
    ...
    `}createRenderRoot(){return this}};th([L({type:String})],Aa.prototype,"lang",2);Aa=th([ie("projects-multiplayer")],Aa);var v0=Object.getOwnPropertyDescriptor,b0=(s,e,t,i)=>{for(var n=i>1?void 0:i?v0(e,t):e,r=s.length-1,o;r>=0;r--)(o=s[r])&&(n=o(n)||n);return n};let Jc=class extends ui(G){render(){return R`
    ...
    `}createRenderRoot(){return this}};Jc=b0([ie("projects-index")],Jc);var y0=Object.defineProperty,x0=Object.getOwnPropertyDescriptor,Cl=(s,e,t,i)=>{for(var n=i>1?void 0:i?x0(e,t):e,r=s.length-1,o;r>=0;r--)(o=s[r])&&(n=(i?o(e,t,n):o(n))||n);return i&&n&&y0(e,t,n),n};let ho=class extends G{constructor(){super(...arguments),this.reverse=!1,this.customClass=""}render(){return R`
      <div
